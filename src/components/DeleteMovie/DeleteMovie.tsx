...
type DeleteMovieWindowProps = {        
    ...
    movieId: string;   
    onHandleShowDeleteMovieWindow: (e: React.MouseEvent<HTMLButtonElement> 
        ...
        return(
            <div className="delete-movie-window">
                <div className="delete-movie-modal">
                    ...
                    <a className="delete-movie-close" href="#" onClick={this.props.onHandleShowDeleteMovieWindow}>&times;</a>
