        ...
        <div className="add-movie-window">
            <div className="add-movie-modal">
                ...
                <div className="add-movie-content">
                    ...
                    value={this.state.url} onChange={this.onChangeInput} />   
                    ...
                    <label className="label-text" htmlFor="overview">Overview</label>
                    <input className="input-text" id="overview" name="overview" placeholder="Overview here" 
                    value={this.state.overview} onChange={this.onChangeInput}/>

                    <label className="label-text" htmlFor="runtime">Runtime</label>
                    <input className="input-text" id="runtime" name="runtime" placeholder="Runtime here"
                    value={this.state.runtime} onChange={this.onChangeInput} />   
                </div>
                <div className="actions">
                    <button className="btn btn-reset" onClick={this.onResetClicked}>
                       Reset
                    </button>
