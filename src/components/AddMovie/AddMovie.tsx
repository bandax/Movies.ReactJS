        ...
        return (
                <>  
                    <div className="add-movie col-2">
                        <button className="btn btn-add-movie" onClick={this.handleShowAddMovieWindow}>+Add Movie</button>
                    </div>
                    <div className="add-movie col-2">
                        <button className="btn btn-add-movie" onClick={this.handleShowDeleteMovieWindow}>+Delete Movie</button>
                    </div>
                    <AddMovieWindow 
